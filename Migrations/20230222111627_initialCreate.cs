        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    finance_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    finance_description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    finance_amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    finance_type = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_categories = table.Column<int>(type: "int", nullable: false),
                    total_inventory = table.Column<int>(type: "int", nullable: false),
                    total_sales = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    total_orders = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreStatistics", x => x.StoreId);
                    table.ForeignKey(
                        name: "FK_StoreStatistics_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanEditProducts = table.Column<bool>(type: "bit", nullable: false),
                    CanDeleteProducts = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorePermissions", x => x.PermissionId);
                    table.ForeignKey(
                        name: "FK_StorePermissions_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolidayLeft = table.Column<int>(type: "int", nullable: false),
                    HolidayPenaltyAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryAlertQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorePermissions_StoreId",
